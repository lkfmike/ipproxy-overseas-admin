              ...
              <template #default="scope">
                <div class="row-actions">
                  <el-tooltip content="查看详情" placement="top" :show-after="500">
                    <el-button link type="primary" class="action-icon-btn" @click="handleViewDetail(scope.row)">
                      <el-icon><Monitor /></el-icon>
                    </el-button>
                  </el-tooltip>
                  <el-tooltip content="编辑配置" placement="top" :show-after="500">
                    <el-button link type="primary" class="action-icon-btn" @click="handleEdit(scope.row)">
...
.filter-form {
  ...
  .status-option {
    ...
    &.active::before { background-color: #67C23A; }
    &.expired::before { background-color: #F56C6C; }
  }
}
...
.status-badge {
  ...
  &.active {
    ...
    color: #00B42A;
    .dot { background-color: #00B42A; }
  }
  
  &.expired {
    background-color: #FFECE8;
    color: #F53F3F;
    .dot { background-color: #F53F3F; }
  }
}
